...
export const metadata: Metadata = {
  title: "Página no encontrada · Clima Reformas Vendrell",
  description: "La página que buscas no existe o ha sido movida. Vuelve al inicio o contacta con nosotros.",
    ...
    <section className="bg-dark min-h-[80vh] flex items-center justify-center px-5">
      <div className="text-center max-w-[600px] flex flex-col items-center gap-6">
        ...
        <p className="font-body text-white/55 text-base md:text-lg leading-relaxed">
          La página que buscabas no existe o se ha movido. Puede ser un enlace roto o una dirección mal escrita. Te ayudamos a encontrar lo que necesitabas.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-3 mt-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-accent text-white px-8 py-4 rounded-full font-body font-bold text-[15px] hover:bg-accent-light transition-colors"
          >
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-6 text-white/35 text-sm font-body">

...
export const metadata: Metadata = {
  title: "Política de Cookies · Clima Reformas Vendrell",
  description: "Política de cookies de reformasvendrell.es: tipos de cookies utilizados en este sitio web, finalidades y cómo aceptarlas o rechazarlas desde tu navegador.",
      ...
      <section className="bg-beige px-5 py-16 md:py-24">
        <div className="mx-auto max-w-[800px] font-body text-dark space-y-8">
          ...
          <div>
            ...
            <p className="text-subtitle leading-relaxed">
              Clima Reformas Vendrell puede modificar esta Política de Cookies en función de exigencias legislativas, reglamentarias, o con la finalidad de adaptar dicha política a las instrucciones dictadas por la Agencia Española de Protección de Datos. Se aconseja a los usuarios que la visiten periódicamente.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-subtitle leading-relaxed">
              Si tienes alguna duda sobre esta Política de Cookies, puedes contactarnos en <a href="mailto:info@reformasvendrell.es" className="text-accent underline">info@reformasvendrell.es</a> o en el teléfono 877 278 163.
            </p>
          </div>
        </div>
      </section>

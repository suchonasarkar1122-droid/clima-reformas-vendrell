...
const zoneLinks = [
  { label: "Reformas en El Vendrell", href: "/" },
  { label: "Reformas en Calafell", href: "/zonas/reformas-calafell" },
  { label: "Reformas en Cunit", href: "/zonas/reformas-cunit" },
  { label: "Reformas en L'Arboç", href: "/zonas/reformas-arboc" },
  { label: "Reformas en Roda de Berà", href: "/zonas/reformas-roda-de-bera" },
  { label: "Reformas en Banyeres del Penedès", href: "/zonas/reformas-banyeres-penedes" },
];
        ...
        <div className="flex flex-col gap-12 pt-16 pb-8">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8">
            <div className="flex items-center gap-4">
              ...
              <Image src="/images/logo.webp" alt="Clima Reformas Vendrell" width={320} height={203} className="h-32 w-auto" />
            </Link>
            </div>

            <h2 className="font-body font-bold text-[18px] sm:text-[22px] md:text-[28px] uppercase leading-[1.2] max-w-[460px] text-white/90">
              Renovamos tu hogar costero con oficio y materiales que duran.
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-3 text-sm text-white/60 font-body">
                <a href="tel:+34877278163" className="hover:text-white transition-colors flex items-center gap-2">
                ...
                <a href="mailto:info@reformasvendrell.es" className="hover:text-white transition-colors flex items-center gap-2">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" className="flex-shrink-0 text-accent/70">
                ...
                <span className="flex items-start gap-2">
                  ...
                  C/ Apel·les Fenosa, 16, 43700 El Vendrell, Tarragona
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 pt-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              <p className="text-white/30 text-xs font-body">
                &copy; {new Date().getFullYear()} Clima Reformas Vendrell. Todos los derechos reservados.
              </p>

  ...
  return (
    <div className="bg-white rounded-[20px] p-6 md:p-7 flex flex-col h-full shadow-sm border border-dark/5">
      ...
      <div className="flex gap-1 mt-1 mb-4">
        {[...Array(5)].map((_, i) => (
          <svg key={i} width="16" height="16" viewBox="0 0 24 24" fill="#D89564" stroke="none">
            <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
          </svg>
        ))}
      </div>

      <p className="font-body font-semibold text-dark leading-[1.6] text-[14px] md:text-[15px] flex-1">
        &ldquo;{quote}&rdquo;
      </p>

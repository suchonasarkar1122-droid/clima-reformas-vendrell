...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center px-5 md:px-10 lg:px-20 py-5">
        <div className="flex items-center justify-between w-full max-w-[1400px]">
          ...
          <Link href="/" className="flex-shrink-0 flex items-center gap-3">
            <Image src="/images/logo.webp" alt="Clima Reformas Vendrell" width={320} height={203} className="h-[90px] w-auto" priority />
          </Link>
      ...
      {/* Mobile Menu */}
      {mobileOpen && (
        <div className="lg:hidden bg-dark/95 backdrop-blur-md border-t border-white/10 rounded-b-[10px] max-h-[calc(100vh-80px)] overflow-y-auto">
          <nav className="flex flex-col px-5 py-6 gap-3">
            ...
            <a href="tel:+34877278163" className="text-accent text-base font-bold py-2">877 278 163</a>
